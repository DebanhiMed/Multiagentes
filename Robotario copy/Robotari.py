...
def expand_obstacle(obstacle, expansion=0.2):
    expanded_obstacle = []
...
obstacle_1 = load_obstacle('Obstacle1.txt')
obstacle_2 = load_obstacle('Obstacle2.txt')
obstacle_3 = load_obstacle('Obstacle3.txt')
obstacle_4 = load_obstacle('Obstacle4.txt')
